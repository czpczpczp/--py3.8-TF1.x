...
for epoch in range(1000):
    ...
    lose = sess.run(loss, feed_dict={
        x: x_test,
        t: y_test
    })

    history['val_acc'].append(accu)
    history['val_loss'].append(lose)
    ...
    if epoch % 50 == 0:
        ...
        plt.plot(range(epoch), history['val_acc'], label='acc', color='black')
...
plt.plot(range(epoch+1), history['val_acc'], label='acc', color='black')
